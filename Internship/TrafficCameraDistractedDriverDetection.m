...
function [] = TrafficCameraDistractedDriverDetection(backgroundFrame, framesToProcess)
	...
	%navigate to frames 
	%configured for home desktop
	cd 'E:\MediaOperations\Media';
	...
	%give initial process headstart of 1 to analyze two images neccesary.
		...
		for i = 1:framesToProcess
			...
			%initialize C matrix before ending while loop
			C = ones(1);
	...
	finished = 'done';
	cd 'C:\Users\Vidur\Skydrive\EX\Internships\TrafficCameraDistractedDriverDetection\Octave';
